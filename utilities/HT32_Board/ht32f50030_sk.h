/*********************************************************************************************************//**
 * @file    ht32f50030_sk.h
 * @version $Rev:: 6198         $
 * @date    $Date:: 2022-10-04 #$
 * @brief   The header file of HT32F50030 Starter kit.
 *************************************************************************************************************
 * @attention
 *
...
#ifndef __HT32F50030_SK_H
#define __HT32F50030_SK_H
...
/** @addtogroup HT32F50030_SK
  * @{
  */


/* Exported constants --------------------------------------------------------------------------------------*/
/** @defgroup HT32F50030_SK_Exported_Constants HT32F50030 Starter kit exported constants
  * @{
  */
extern HT_GPIO_TypeDef* const GPIO_PORT[GPIO_PORT_NUM];

/** @addtogroup HT32F50030_SK_LED
  * @{
  */
#define LEDn                        (3)
...
/** @addtogroup HT32F50030_SK_BUTTON
  * @{
  */
#define BUTTONn                     (3)

#define WAKEUP_BUTTON_GPIO_ID       (GPIO_PB)
#define WAKEUP_BUTTON_GPIO_PIN      (GPIO_PIN_9)
#define WAKEUP_BUTTON_AFIO_MODE     (AFIO_FUN_GPIO)
#define WAKEUP_BUTTON_EXTI_CHANNEL  (9)

#define KEY1_BUTTON_GPIO_ID         (GPIO_PB)
#define KEY1_BUTTON_GPIO_PIN        (GPIO_PIN_3)
#define KEY1_BUTTON_AFIO_MODE       (AFIO_FUN_GPIO)
#define KEY1_BUTTON_EXTI_CHANNEL    (3)

#define KEY2_BUTTON_GPIO_ID         (GPIO_PB)
#define KEY2_BUTTON_GPIO_PIN        (GPIO_PIN_4)
#define KEY2_BUTTON_AFIO_MODE       (AFIO_FUN_GPIO)
#define KEY2_BUTTON_EXTI_CHANNEL    (4)
...
/** @addtogroup HT32F50030_SK_BUZZER
  * @{
  */
...
/** @addtogroup HT32F50030_SK_SPI_FLASH
  * @{
  */
...
/** @addtogroup HT32F50030_SK_SPI_LCD
  * @{
  */
...
#define LCD_SPI_SEL_AFIO_PIN        (AFIO_PIN_15)
...
/** @addtogroup HT32F50030_SK_I2C_EEPROM
  * @{
  */
...
/* Exported functions --------------------------------------------------------------------------------------*/
/** @defgroup HT32F50030_SK_Exported_Functions HT32F50030 Starter kit exported functions
  * @{
  */
