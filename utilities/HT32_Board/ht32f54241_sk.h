/*********************************************************************************************************//**
 * @file    ht32f54241_sk.h
 * @version $Rev:: 5675         $
 * @date    $Date:: 2021-12-23 #$
 * @brief   The header file of HT32F54241 Starter kit.
 *************************************************************************************************************
 * @attention
 *
...
#ifndef __HT32F54241_SK_H
#define __HT32F54241_SK_H
...
/** @addtogroup HT32F54241_SK
  * @{
  */


/* Exported constants --------------------------------------------------------------------------------------*/
/** @defgroup HT32F54241_SK_Exported_Constants HT32F54241 Starter kit exported constants
  * @{
  */
extern HT_GPIO_TypeDef* const GPIO_PORT[GPIO_PORT_NUM];

/** @addtogroup HT32F54241_SK_LED
  * @{
  */
#define LEDn                        (3)
...
#define LED3_GPIO_ID                (GPIO_PB)          /* Default not work, please check the schematic.     */
...
/** @addtogroup HT32F54241_SK_BUTTON
  * @{
  */
#define BUTTONn                     (3)
...
#define KEY1_BUTTON_GPIO_ID         (GPIO_PA)          /* Default not work, please check the schematic.     */
#define KEY1_BUTTON_GPIO_PIN        (GPIO_PIN_14)
#define KEY1_BUTTON_AFIO_MODE       (AFIO_FUN_GPIO)
#define KEY1_BUTTON_EXTI_CHANNEL    (14)

#define KEY2_BUTTON_GPIO_ID         (GPIO_PB)          /* Default not work, please check the schematic.     */
...
/** @addtogroup HT32F54241_SK_BUZZER
  * @{
  */
#define BUZZER_GPIO_ID              (GPIO_PC)
#define BUZZER_AFIO_PIN             (AFIO_PIN_5)
...
/** @addtogroup HT32F54241_SK_SPI_FLASH
  * @{
  */
...
/** @addtogroup HT32F54241_SK_SPI_LCD
  * @{
  */
...
#define LCD_SPI_SCK_AFIO_PIN        (AFIO_PIN_0)
...
#define LCD_SPI_RST_UNUSE           (1)
#if (LCD_SPI_RST_UNUSE == 0)
#define LCD_SPI_RST_GPIO_ID         (GPIO_PC)
#define LCD_SPI_RST_GPIO_PIN        (GPIO_PIN_4)
...
/** @addtogroup HT32F54241_SK_I2C_EEPROM
  * @{
  */
...
/* Exported functions --------------------------------------------------------------------------------------*/
/** @defgroup HT32F54241_SK_Exported_Functions HT32F54241 Starter kit exported functions
  * @{
  */
