 ...
 * @brief   The header file of HT32F0008 Starter kit.
 *************************************************************************************************************
 * @attention
 *
...
#ifndef __HT32F0008_SK_H
#define __HT32F0008_SK_H
...
/** @addtogroup HT32F0008_SK
  * @{
  */


/* Exported constants --------------------------------------------------------------------------------------*/
/** @defgroup HT32F0008_SK_Exported_Constants HT32F0008 Starter kit exported constants
  * @{
  */
extern HT_GPIO_TypeDef* const GPIO_PORT[GPIO_PORT_NUM];

/** @addtogroup HT32F0008_SK_LED
  * @{
  */
#define LEDn                        (3)
...
/** @addtogroup HT32F0008_SK_BUTTON
  * @{
  */
#define BUTTONn                     (3)
...
/** @addtogroup HT32F0008_SK_BUZZER
  * @{
  */
#define BUZZER_GPIO_ID              (GPIO_PA)
#define BUZZER_AFIO_PIN             (AFIO_PIN_8)
#define BUZZER_AFIO_MODE            (AFIO_FUN_PWM)
#define BUZZER_GPIO_CLK(CK)         (CK.Bit.PA)

#define BUZZER_TM_CLK(CK)           (CK.Bit.PWM1)
#define BUZZER_TM                   (HT_PWM1)
#define BUZZER_TM_CHANNEL           (TM_CH_3)
#define BUZZER_IRQn                 (PWM1_IRQn)
/**
  * @}
  */

/** @addtogroup HT32F0008_SK_COM
  * @{
  */
#define COM_NUM                     (1)
...
/** @addtogroup HT32F0008_SK_SPI_FLASH
  * @{
  */
...
/** @addtogroup HT32F0008_SK_SPI_LCD
  * @{
  */
...
/** @addtogroup HT32F0008_SK_I2C_EEPROM
  * @{
  */
...
/* Exported functions --------------------------------------------------------------------------------------*/
/** @defgroup HT32F0008_SK_Exported_Functions HT32F0008 Starter kit exported functions
  * @{
  */
