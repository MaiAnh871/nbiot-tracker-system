/*********************************************************************************************************//**
 * @file    ht32f52367_sk.h
 * @version $Rev:: 5821         $
 * @date    $Date:: 2022-04-15 #$
 * @brief   The header file of HT32F52367 Starter kit.
 *************************************************************************************************************
 * @attention
 *
...
#ifndef __HT32F52367_SK_H
#define __HT32F52367_SK_H
...
/** @addtogroup HT32F52367_SK
  * @{
  */


/* Exported constants --------------------------------------------------------------------------------------*/
/** @defgroup HT32F52367_SK_Exported_Constants HT32F52367 Starter kit exported constants
  * @{
  */
extern HT_GPIO_TypeDef* const GPIO_PORT[GPIO_PORT_NUM];

/** @addtogroup HT32F52367_SK_LED
  * @{
  */
#define LEDn                        (3)
...
/** @addtogroup HT32F52367_SK_BUTTON
  * @{
  */
#define BUTTONn                     (3)
...
#define KEY1_BUTTON_GPIO_PIN        (GPIO_PIN_15)
#define KEY1_BUTTON_AFIO_MODE       (AFIO_FUN_GPIO)
#define KEY1_BUTTON_EXTI_CHANNEL    (15)

#define KEY2_BUTTON_GPIO_ID         (GPIO_PE)
...
/** @addtogroup HT32F52367_SK_BUZZER
  * @{
  */
#define BUZZER_GPIO_ID              (GPIO_PC)
#define BUZZER_AFIO_PIN             (AFIO_PIN_13)
...
/** @addtogroup HT32F52367_SK_SPI_FLASH
  * @{
  */
...
#define FLASH_SPI_MOSI_GPIO_ID      (GPIO_PD)       /* QSPI: SIO0 pin                                       */
#define FLASH_SPI_MOSI_AFIO_PIN     (AFIO_PIN_12)
#define FLASH_SPI_MOSI_AFIO_MODE    (AFIO_FUN_SPI)

#define FLASH_SPI_MISO_GPIO_ID      (GPIO_PD)       /* QSPI: SIO1 pin                                       */
#define FLASH_SPI_MISO_AFIO_PIN     (AFIO_PIN_13)
#define FLASH_SPI_MISO_AFIO_MODE    (AFIO_FUN_SPI)

#define FLASH_SPI_SIO2_GPIO_ID      (GPIO_PD)       /* QSPI: SIO2 pin                                       */
#define FLASH_SPI_SIO2_AFIO_PIN     (AFIO_PIN_14)
#define FLASH_SPI_SIO2_AFIO_MODE    (AFIO_FUN_SPI)

#define FLASH_SPI_SIO3_GPIO_ID      (GPIO_PD)       /* QSPI: SIO3 pin                                       */
#define FLASH_SPI_SIO3_AFIO_PIN     (AFIO_PIN_15)
...
/** @addtogroup HT32F52367_SK_EBI_LCD
  * @{
  */
...
#define LCD_EBI_RS_GPIO_ID          (GPIO_PE)
#define LCD_EBI_RS_AFIO_PIN         (AFIO_PIN_0)
#define LCD_EBI_RS_AFIO_MODE        (AFIO_FUN_EBI)
#define LCD_EBI_RS_ADDR_PIN         (11)

#define LCD_EBI_RS1_GPIO_ID         (GPIO_PE)
#define LCD_EBI_RS1_AFIO_PIN        (AFIO_PIN_1)
#define LCD_EBI_RS1_AFIO_MODE       (AFIO_FUN_EBI)
#define LCD_EBI_RS1_ADDR_PIN        (12)
...
#define LCD_EBI_BL_GPIO_PIN         (GPIO_PIN_0)
...
/** @addtogroup HT32F52367_SK_SPI_LCD
  * @{
  */
...
#define LCD_SPI_SCK_AFIO_PIN        (AFIO_PIN_11)
#define LCD_SPI_SCK_AFIO_MODE       (AFIO_FUN_SPI)

#define LCD_SPI_MOSI_GPIO_ID        (GPIO_PC)
#define LCD_SPI_MOSI_AFIO_PIN       (AFIO_PIN_12)
...
#define LCD_SPI_BL_GPIO_ID          (GPIO_PD)
#define LCD_SPI_BL_GPIO_PIN         (GPIO_PIN_0)
#define LCD_SPI_BL_AFIO_MODE        (AFIO_FUN_GPIO)
#define LCD_SPI_BL_CLK(CK)          (CK.Bit.PD)
...
/** @addtogroup HT32F52367_SK_I2C_EEPROM
  * @{
  */
...
/* Exported functions --------------------------------------------------------------------------------------*/
/** @defgroup HT32F52367_SK_Exported_Functions HT32F52367 Starter kit exported functions
  * @{
  */
