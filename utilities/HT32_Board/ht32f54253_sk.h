/*********************************************************************************************************//**
 * @file    ht32f54253_sk.h
 * @version $Rev:: 5629         $
 * @date    $Date:: 2021-11-09 #$
 * @brief   The header file of HT32F54253 Starter kit.
 *************************************************************************************************************
 * @attention
 *
...
#ifndef __HT32F54253_SK_H
#define __HT32F54253_SK_H
...
/** @addtogroup HT32F54253_SK
  * @{
  */


/* Exported constants --------------------------------------------------------------------------------------*/
/** @defgroup HT32F54253_SK_Exported_Constants HT32F54253 Starter kit exported constants
  * @{
  */
extern HT_GPIO_TypeDef* const GPIO_PORT[GPIO_PORT_NUM];

/** @addtogroup HT32F54253_SK_LED
  * @{
  */
#define LEDn                        (3)
...
/** @addtogroup HT32F54253_SK_BUTTON
  * @{
  */
#define BUTTONn                     (3)
...
/** @addtogroup HT32F54253_SK_BUZZER
  * @{
  */
#define BUZZER_GPIO_ID              (GPIO_PC)
#define BUZZER_AFIO_PIN             (AFIO_PIN_12)
...
#define BUZZER_TM_CHANNEL           (TM_CH_2)
#define BUZZER_IRQn                 (GPTM0_IRQn)
/**
  * @}
  */

/** @addtogroup HT32F54253_SK_COM
  * @{
  */
#define COM_NUM                     (1)
...
/** @addtogroup HT32F54253_SK_SPI_FLASH
  * @{
  */
...
#define FLASH_SPI_MOSI_AFIO_PIN     (AFIO_PIN_3)
...
/** @addtogroup HT32F54253_SK_SPI_LCD
  * @{
  */
...
#define LCD_SPI_RST_GPIO_ID         (GPIO_PD)
...
/** @addtogroup HT32F54253_SK_I2C_EEPROM
  * @{
  */
...
/* Exported functions --------------------------------------------------------------------------------------*/
/** @defgroup HT32F54253_SK_Exported_Functions HT32F54253 Starter kit exported functions
  * @{
  */
