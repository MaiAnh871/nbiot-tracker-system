/*********************************************************************************************************//**
 * @file    ht32f67051_sk.h
 * @version $Rev:: 6523         $
 * @date    $Date:: 2022-12-06 #$
 * @brief   The header file of HT32F67051 Starter kit (temporary file, not finish/support yet).
 *************************************************************************************************************
 * @attention
 *
...
#ifndef __HT32F67051_SK_H
#define __HT32F67051_SK_H
...
/** @addtogroup HT32F67051_SK
  * @{
  */


/* Exported constants --------------------------------------------------------------------------------------*/
/** @defgroup HT32F67051_SK_Exported_Constants HT32F67051 Starter kit exported constants
  * @{
  */
extern HT_GPIO_TypeDef* const GPIO_PORT[GPIO_PORT_NUM];

/** @addtogroup HT32F67051_SK_LED
  * @{
  */
#define LEDn                        (3)
...
/** @addtogroup HT32F67051_SK_BUTTON
  * @{
  */
#define BUTTONn                     (3)
...
/** @addtogroup HT32F67051_SK_BUZZER
  * @{
  */
...
/** @addtogroup HT32F67051_SK_SPI_FLASH
  * @{
  */
...
#define FLASH_SPI_SEL_GPIO_PIN      (GPIO_PIN_15)
...
/** @addtogroup HT32F67051_SK_SPI_LCD
  * @{
  */
...
#define LCD_SPI_SEL_AFIO_PIN        (AFIO_PIN_4)
...
/** @addtogroup HT32F67051_SK_I2C_EEPROM
  * @{
  */
...
#define EEPROM_I2C_SCL_AFIO_PIN     (AFIO_PIN_7)
#define EEPROM_I2C_SCL_AFIO_MODE    (AFIO_FUN_I2C)

#define EEPROM_I2C_SDA_GPIO_ID      (GPIO_PB)
#define EEPROM_I2C_SDA_AFIO_PIN     (AFIO_PIN_8)
...
/* Exported functions --------------------------------------------------------------------------------------*/
/** @defgroup HT32F67051_SK_Exported_Functions HT32F67051 Starter kit exported functions
  * @{
  */
