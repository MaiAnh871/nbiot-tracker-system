/*********************************************************************************************************//**
 * @file    ht32f52354_sk.h
 * @version $Rev:: 5629         $
 * @date    $Date:: 2021-11-09 #$
 * @brief   The header file of HT32F52354 Starter kit.
 *************************************************************************************************************
 * @attention
 *
...
#ifndef __HT32F52354_SK_H
#define __HT32F52354_SK_H
...
/** @addtogroup HT32F52354_SK
  * @{
  */


/* Exported constants --------------------------------------------------------------------------------------*/
/** @defgroup HT32F52354_SK_Exported_Constants HT32F52354 Starter kit exported constants
  * @{
  */
extern HT_GPIO_TypeDef* const GPIO_PORT[GPIO_PORT_NUM];

/** @addtogroup HT32F52354_SK_LED
  * @{
  */
#define LEDn                        (3)
...
/** @addtogroup HT32F52354_SK_BUTTON
  * @{
  */
#define BUTTONn                     (3)
...
/** @addtogroup HT32F52354_SK_BUZZER
  * @{
  */
...
/** @addtogroup HT32F52354_SK_SPI_FLASH
  * @{
  */
...
#define FLASH_SPI_SEL_GPIO_PIN      (GPIO_PIN_3)
...
/** @addtogroup HT32F52354_SK_EBI_LCD
  * @{
  */
...
#define LCD_EBI_RS_ADDR_PIN         (18)

#define LCD_EBI_RS1_GPIO_ID         (GPIO_PD)
#define LCD_EBI_RS1_AFIO_PIN        (AFIO_PIN_0)
#define LCD_EBI_RS1_AFIO_MODE       (AFIO_FUN_EBI)
#define LCD_EBI_RS1_ADDR_PIN        (18)
...
#define LCD_EBI_BL_GPIO_ID          (GPIO_PA)
#define LCD_EBI_BL_GPIO_PIN         (GPIO_PIN_8)
#define LCD_EBI_BL_AFIO_MODE        (AFIO_FUN_GPIO)
#define LCD_EBI_BL_CLK(CK)          (CK.Bit.PA)
...
/** @addtogroup HT32F52354_SK_SPI_LCD
  * @{
  */
...
#define LCD_SPI_BL_GPIO_PIN         (GPIO_PIN_8)
...
/** @addtogroup HT32F52354_SK_I2C_EEPROM
  * @{
  */
...
/* Exported functions --------------------------------------------------------------------------------------*/
/** @defgroup HT32F52354_SK_Exported_Functions HT32F52354 Starter kit exported functions
  * @{
  */
