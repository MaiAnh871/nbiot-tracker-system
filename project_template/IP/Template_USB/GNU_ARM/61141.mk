...
#/*---------------------------------------------------------------------------------------------------------*/
CHIP_NAME = 61141
STARTUP = startup_ht32f5xxxx_gcc_12
TARGET_NAME = HT32
...
C_OPTION += -DUSE_HT32F61141_SK
C_OPTION += -DUSE_HT32F61141
C_OPTION += -DUSE_MEM_HT32F61141
S_OPTION = --defsym USE_HT32_CHIP=23
...
SOURCE_NAME_PATH += ../system_ht32f5xxxx_12.c
