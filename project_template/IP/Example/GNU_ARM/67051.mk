...
#/*---------------------------------------------------------------------------------------------------------*/
CHIP_NAME = 67051
STARTUP = startup_ht32f5xxxx_gcc_11
TARGET_NAME = HT32
...
C_OPTION += -DUSE_HT32F67051_SK
C_OPTION += -DUSE_HT32F67041_51
C_OPTION += -DUSE_MEM_HT32F67051
S_OPTION = --defsym USE_HT32_CHIP=22
...
SOURCE_NAME_PATH += ../system_ht32f5xxxx_11.c
