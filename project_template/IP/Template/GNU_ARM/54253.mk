...
#/*---------------------------------------------------------------------------------------------------------*/
CHIP_NAME = 54253
STARTUP = startup_ht32f5xxxx_gcc_09
TARGET_NAME = HT32
...
C_OPTION += -DUSE_HT32F54253_SK
C_OPTION += -DUSE_HT32F54243_53
C_OPTION += -DUSE_MEM_HT32F54253
S_OPTION = --defsym USE_HT32_CHIP=20
...
SOURCE_NAME_PATH += ../system_ht32f5xxxx_09.c
...
$(HT32_LIB_PATH)ht32f5xxxx_ledc.c \
...
$(HT32_LIB_PATH)ht32f5xxxx_tkey.c \
