...
#/*---------------------------------------------------------------------------------------------------------*/
CHIP_NAME = 65240
STARTUP = startup_ht32f5xxxx_gcc_08
TARGET_NAME = HT32
...
C_OPTION += -DUSE_HT32F65240_SK
C_OPTION += -DUSE_HT32F65230_40
C_OPTION += -DUSE_MEM_HT32F65240
S_OPTION = --defsym USE_HT32_CHIP=12
...
SOURCE_NAME_PATH += ../system_ht32f5xxxx_08.c
...
$(HT32_LIB_PATH)ht32f652xx_adc.c \
...
$(HT32_LIB_PATH)ht32f652xx_opa.c \
