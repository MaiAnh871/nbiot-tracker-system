...
REM * @version $Rev:: 6302         $
REM * @date    $Date:: 2022-10-18 #$
...
XCOPY /-Y /S /Q "..\..\..\project_template\IP\%PRO_TYPE%\MDK_ARMv537\%STARTUP_FILE_PREFIX%%STARTUP_FILE_NUM%.s"  ".\MDK_ARMv537\" < dummyn.txt 1> nul 2>&1
XCOPY /-Y /S /Q "..\..\..\project_template\IP\%PRO_TYPE%\MDK_ARMv537\%STARTUP_FILE_PREFIX%%STARTUP_FILE_NUM1%.s"  ".\MDK_ARMv537\" < dummyn.txt 1> nul 2>&1
