...
#/*---------------------------------------------------------------------------------------------------------*/
CHIP_NAME = 61356
STARTUP = startup_ht32f5xxxx_gcc_07
TARGET_NAME = HT32
...
C_OPTION += -DUSE_HT32F61356_SK
C_OPTION += -DUSE_HT32F61355_56_57
C_OPTION += -DUSE_MEM_HT32F61356
S_OPTION = --defsym USE_HT32_CHIP=17
...
SOURCE_NAME_PATH += ../system_ht32f5xxxx_07.c
...
$(HT32_LIB_PATH)ht32f5xxxx_dac_dual16.c \
...
$(HT32_LIB_PATH)ht32f5xxxx_midi.c \
