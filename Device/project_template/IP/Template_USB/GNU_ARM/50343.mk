...
#/*---------------------------------------------------------------------------------------------------------*/
CHIP_NAME = 50343
STARTUP = startup_ht32f5xxxx_gcc_06
TARGET_NAME = HT32
...
C_OPTION += -DUSE_HT32F50343_SK
C_OPTION += -DUSE_HT32F50343
C_OPTION += -DUSE_MEM_HT32F50343
S_OPTION = --defsym USE_HT32_CHIP=15
...
SOURCE_NAME_PATH += ../system_ht32f5xxxx_06.c
...
$(HT32_LIB_PATH)ht32f5xxxx_sled.c \
