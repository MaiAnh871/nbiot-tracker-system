...
#/*---------------------------------------------------------------------------------------------------------*/
CHIP_NAME = 61245
STARTUP = startup_ht32f5xxxx_gcc_10
TARGET_NAME = HT32
...
C_OPTION += -DUSE_HT32F61245_SK
C_OPTION += -DUSE_HT32F61244_45
C_OPTION += -DUSE_MEM_HT32F61245
S_OPTION = --defsym USE_HT32_CHIP=24
...
SOURCE_NAME_PATH += ../system_ht32f5xxxx_10.c
...
$(HT32_LIB_PATH)ht32f5xxxx_lstm.c \
