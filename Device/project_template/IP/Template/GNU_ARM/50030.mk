...
#/*---------------------------------------------------------------------------------------------------------*/
CHIP_NAME = 50030
STARTUP = startup_ht32f5xxxx_gcc_13
TARGET_NAME = HT32
...
C_OPTION += -DUSE_HT32F50030_SK
C_OPTION += -DUSE_HT32F50020_30
C_OPTION += -DUSE_MEM_HT32F50030
S_OPTION = --defsym USE_HT32_CHIP=25
...
SOURCE_NAME_PATH += ../system_ht32f5xxxx_13.c
