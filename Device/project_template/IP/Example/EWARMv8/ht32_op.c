...
#define OPT_RES   (0xFFFFFFFF)
  ...
  #if (BOOT_OPT == 1 && WDT_OPT == 1)
    #error "The selected MCU can not enable Bootloader Waiting Time (BOOT_OPT = 1) and Watchdog Timer Auto Enable (WDT_OPT = 1) in the same time!"
  #endif

  #if (BOOT_OPT == 0 && WDT_OPT == 0)
