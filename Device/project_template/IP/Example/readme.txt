...
Note 2: MDK-ARM V5.37 uses Arm Compiler Version 6 as the default compiler. For the situation,
        add MDK_ARMv537 project template to support version after MDK-ARM V537.
</PRE>
