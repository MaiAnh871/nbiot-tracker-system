...
#/*---------------------------------------------------------------------------------------------------------*/
CHIP_NAME = 50230
STARTUP = startup_ht32f5xxxx_gcc_02
TARGET_NAME = HT32
...
C_OPTION += -DUSE_HT32F50230_SK
C_OPTION += -DUSE_HT32F50220_30
C_OPTION += -DUSE_MEM_HT32F50230
S_OPTION = --defsym USE_HT32_CHIP=7
...
SOURCE_NAME_PATH += ../system_ht32f5xxxx_04.c
