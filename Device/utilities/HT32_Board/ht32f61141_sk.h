/*********************************************************************************************************//**
 * @file    ht32f61141_sk.h
 * @version $Rev:: 5656         $
 * @date    $Date:: 2021-11-24 #$
 * @brief   The header file of HT32F61141 Starter kit (temporary file, not finish/support yet).
 *************************************************************************************************************
 * @attention
 *
...
#ifndef __HT32F61141_SK_H
#define __HT32F61141_SK_H
...
/** @addtogroup HT32F61141_SK
  * @{
  */


/* Exported constants --------------------------------------------------------------------------------------*/
/** @defgroup HT32F61141_SK_Exported_Constants HT32F61141 Starter kit exported constants
  * @{
  */
extern HT_GPIO_TypeDef* const GPIO_PORT[GPIO_PORT_NUM];

/** @addtogroup HT32F61141_SK_LED
  * @{
  */
#define LEDn                        (3)
...
/** @addtogroup HT32F61141_SK_BUTTON
  * @{
  */
#define BUTTONn                     (3)
...
#define KEY2_BUTTON_EXTI_CHANNEL    (10)
...
/** @addtogroup HT32F61141_SK_BUZZER
  * @{
  */
#define BUZZER_GPIO_ID              (GPIO_PA)
#define BUZZER_AFIO_PIN             (AFIO_PIN_11)
#define BUZZER_AFIO_MODE            (AFIO_FUN_SCTM)
#define BUZZER_GPIO_CLK(CK)         (CK.Bit.PA)

#define BUZZER_TM_CLK(CK)           (CK.Bit.SCTM1)
#define BUZZER_TM                   (HT_SCTM1)
#define BUZZER_TM_CHANNEL           (TM_CH_0)
#define BUZZER_IRQn                 (SCTM1_IRQn)
/**
  * @}
  */

/** @addtogroup HT32F61141_SK_COM
  * @{
  */
#define COM_NUM                     (1)
...
/** @addtogroup HT32F61141_SK_SPI_FLASH
  * @{
  */
...
#define FLASH_SPI_SCK_AFIO_PIN      (AFIO_PIN_2)
...
#define FLASH_SPI_MOSI_CLK(CK)      (CK.Bit.PB)
...
/** @addtogroup HT32F61141_SK_SPI_LCD
  * @{
  */
...
/** @addtogroup HT32F61141_SK_I2C_EEPROM
  * @{
  */
...
/* Exported functions --------------------------------------------------------------------------------------*/
/** @defgroup HT32F61141_SK_Exported_Functions HT32F61141 Starter kit exported functions
  * @{
  */
