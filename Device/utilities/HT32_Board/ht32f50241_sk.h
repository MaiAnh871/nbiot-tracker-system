/*********************************************************************************************************//**
 * @file    ht32f50241_sk.h
 * @version $Rev:: 5629         $
 * @date    $Date:: 2021-11-09 #$
 * @brief   The header file of HT32F50241 Starter kit.
 *************************************************************************************************************
 * @attention
 *
...
#ifndef __HT32F50241_SK_H
#define __HT32F50241_SK_H
...
/** @addtogroup HT32F50241_SK
  * @{
  */


/* Exported constants --------------------------------------------------------------------------------------*/
/** @defgroup HT32F50241_SK_Exported_Constants HT32F50241 Starter kit exported constants
  * @{
  */
extern HT_GPIO_TypeDef* const GPIO_PORT[GPIO_PORT_NUM];

/** @addtogroup HT32F50241_SK_LED
  * @{
  */
#define LEDn                        (3)
...
/** @addtogroup HT32F50241_SK_BUTTON
  * @{
  */
#define BUTTONn                     (3)
...
#define KEY1_BUTTON_GPIO_PIN        (GPIO_PIN_2)
#define KEY1_BUTTON_AFIO_MODE       (AFIO_FUN_GPIO)
#define KEY1_BUTTON_EXTI_CHANNEL    (2)

#define KEY2_BUTTON_GPIO_ID         (GPIO_PC)
#define KEY2_BUTTON_GPIO_PIN        (GPIO_PIN_3)
#define KEY2_BUTTON_AFIO_MODE       (AFIO_FUN_GPIO)
#define KEY2_BUTTON_EXTI_CHANNEL    (3)
...
/** @addtogroup HT32F50241_SK_BUZZER
  * @{
  */
#define BUZZER_GPIO_ID              (GPIO_PB)
#define BUZZER_AFIO_PIN             (AFIO_PIN_9)
#define BUZZER_AFIO_MODE            (AFIO_FUN_MCTM_GPTM)
#define BUZZER_GPIO_CLK(CK)         (CK.Bit.PB)
...
/** @addtogroup HT32F50241_SK_SPI_FLASH
  * @{
  */
...
#define FLASH_SPI_SEL_GPIO_PIN      (GPIO_PIN_1)
...
/** @addtogroup HT32F50241_SK_SPI_LCD
  * @{
  */
...
#define LCD_SPI_SCK_AFIO_PIN        (AFIO_PIN_15)
#define LCD_SPI_SCK_AFIO_MODE       (AFIO_FUN_SPI)

#define LCD_SPI_MOSI_GPIO_ID        (GPIO_PB)
#define LCD_SPI_MOSI_AFIO_PIN       (AFIO_PIN_0)
#define LCD_SPI_MOSI_AFIO_MODE      (AFIO_FUN_SPI)

#define LCD_SPI_MISO_GPIO_ID        (GPIO_PB)
#define LCD_SPI_MISO_AFIO_PIN       (AFIO_PIN_1)
#define LCD_SPI_MISO_AFIO_MODE      (AFIO_FUN_SPI)

#define LCD_SPI_SEL_GPIO_ENABLE     (0)
#define LCD_SPI_SEL_GPIO_ID         (GPIO_PA)
#define LCD_SPI_SEL_AFIO_PIN        (AFIO_PIN_14)
...
#define LCD_SPI_RST_GPIO_PIN        (GPIO_PIN_2)
...
/** @addtogroup HT32F50241_SK_I2C_EEPROM
  * @{
  */
...
/* Exported functions --------------------------------------------------------------------------------------*/
/** @defgroup HT32F50241_SK_Exported_Functions HT32F50241 Starter kit exported functions
  * @{
  */
