/*********************************************************************************************************//**
 * @file    ht32f65232_sk.h
 * @version $Rev:: 6523         $
 * @date    $Date:: 2022-12-06 #$
 * @brief   The header file of HT32F65232 Starter kit (temporary file, not finish/support yet).
 *************************************************************************************************************
 * @attention
 *
...
#ifndef __HT32F65232_SK_H
#define __HT32F65232_SK_H
...
/** @addtogroup HT32F65232_SK
  * @{
  */


/* Exported constants --------------------------------------------------------------------------------------*/
/** @defgroup HT32F65232_SK_Exported_Constants HT32F65240 Starter kit exported constants
  * @{
  */
extern HT_GPIO_TypeDef* const GPIO_PORT[GPIO_PORT_NUM];

/** @addtogroup HT32F65232_SK_LED
  * @{
  */
#define LEDn                        (3)
...
/** @addtogroup HT32F65232_SK_BUTTON
  * @{
  */
#define BUTTONn                     (3)
...
/** @addtogroup HT32F65232_SK_BUZZER
  * @{
  */
...
/** @addtogroup HT32F65232_SK_SPI_FLASH
  * @{
  */
...
#define FLASH_SPI_SEL_GPIO_PIN      (GPIO_PIN_4)
...
/** @addtogroup HT32F65232_SK_SPI_LCD
  * @{
  */
...
#define LCD_SPI_MOSI_AFIO_PIN       (AFIO_PIN_6)
#define LCD_SPI_MOSI_AFIO_MODE      (AFIO_FUN_SPI)

#define LCD_SPI_MISO_GPIO_ID        (GPIO_PC)
#define LCD_SPI_MISO_AFIO_PIN       (AFIO_PIN_7)
...
/** @addtogroup HT32F65232_SK_I2C_EEPROM
  * @{
  */
...
/* Exported functions --------------------------------------------------------------------------------------*/
/** @defgroup HT32F65232_SK_Exported_Functions HT32F65240 Starter kit exported functions
  * @{
  */
