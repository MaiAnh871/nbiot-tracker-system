/*********************************************************************************************************//**
 * @file    ht32f65240_dvb.h
 * @version $Rev:: 5629         $
 * @date    $Date:: 2021-11-09 #$
 * @brief   The header file of HT32F65240 Development Board.
 *************************************************************************************************************
 * @attention
 *
...
#ifndef __HT32F65240_DVB_H
#define __HT32F65240_DVB_H
...
/** @addtogroup HT32F65240_DVB
  * @{
  */


/* Exported constants --------------------------------------------------------------------------------------*/
/** @defgroup HT32F65240_DVB_Exported_Constants HT32F65240 Development Board exported constants
  * @{
  */
extern HT_GPIO_TypeDef* const GPIO_PORT[GPIO_PORT_NUM];

/** @addtogroup HT32F65240_DVB_LED
  * @{
  */
#define LEDn                        (3)
...
/** @addtogroup HT32F65240_DVB_BUTTON
  * @{
  */
#define BUTTONn                     (3)

#define WAKEUP_BUTTON_GPIO_ID       (GPIO_PA)
#define WAKEUP_BUTTON_GPIO_PIN      (GPIO_PIN_6)
#define WAKEUP_BUTTON_AFIO_MODE     (AFIO_FUN_GPIO)
#define WAKEUP_BUTTON_EXTI_CHANNEL  (6)

#define KEY1_BUTTON_GPIO_ID         (GPIO_PB)
#define KEY1_BUTTON_GPIO_PIN        (GPIO_PIN_9)
#define KEY1_BUTTON_AFIO_MODE       (AFIO_FUN_GPIO)
#define KEY1_BUTTON_EXTI_CHANNEL    (9)
...
/** @addtogroup HT32F65240_DVB_BUZZER
  * @{
  */
...
#define COM1_TX_AFIO_PIN            (AFIO_PIN_3)
...
/** @addtogroup HT32F65240_DVB_SPI_FLASH
  * @{
  */
...
#define FLASH_SPI_MISO_AFIO_PIN     (AFIO_PIN_4)
...
/** @addtogroup HT32F65240_DVB_SPI_LCD
  * @{
  */
...
#define LCD_SPI_MISO_AFIO_PIN       (AFIO_PIN_4)
...
#define LCD_SPI_RST_GPIO_PIN        (GPIO_PIN_6)
...
/** @addtogroup HT32F65240_DVB_I2C_EEPROM
  * @{
  */
...
/* Exported functions --------------------------------------------------------------------------------------*/
/** @defgroup HT32F65240_DVB_Exported_Functions HT32F65240 Development Board exported functions
  * @{
  */
