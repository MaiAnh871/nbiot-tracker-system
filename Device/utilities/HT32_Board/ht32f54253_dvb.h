/*********************************************************************************************************//**
 * @file    ht32f54253_dvb.h
 * @version $Rev:: 5657         $
 * @date    $Date:: 2021-11-26 #$
 * @brief   The header file of HT32F54253 Development Board.
 *************************************************************************************************************
 * @attention
 *
...
#ifndef __HT32F54253_DVB_H
#define __HT32F54253_DVB_H
...
/** @addtogroup HT32F54253_DVB
  * @{
  */


/* Exported constants --------------------------------------------------------------------------------------*/
/** @defgroup HT32F54253_DVB_Exported_Constants HT32F54253 Starter kit exported constants
  * @{
  */
extern HT_GPIO_TypeDef* const GPIO_PORT[GPIO_PORT_NUM];

/** @addtogroup HT32F54253_DVB_LED
  * @{
  */
#define LEDn                        (3)
...
/** @addtogroup HT32F54253_DVB_BUTTON
  * @{
  */
#define BUTTONn                     (3)
...
/** @addtogroup HT32F54253_DVB_BUZZER
  * @{
  */
...
#define BUZZER_TM_CLK(CK)           (CK.Bit.SCTM0)
#define BUZZER_TM                   (HT_SCTM0)
#define BUZZER_TM_CHANNEL           (TM_CH_0)
#define BUZZER_IRQn                 (SCTM0_IRQn)
/**
  * @}
  */

/** @addtogroup HT32F54253_DVB_COM
  * @{
  */
#define COM_NUM                     (1)
...
/** @addtogroup HT32F54253_DVB_SPI_FLASH
  * @{
  */
...
/** @addtogroup HT32F54253_DVB_SPI_LCD
  * @{
  */
...
#define LCD_SPI_SEL_AFIO_PIN        (AFIO_PIN_3)
...
/** @addtogroup HT32F54253_DVB_I2C_EEPROM
  * @{
  */
...
#define EEPROM_I2C_SCL_AFIO_PIN     (AFIO_PIN_8)
#define EEPROM_I2C_SCL_AFIO_MODE    (AFIO_FUN_I2C)

#define EEPROM_I2C_SDA_GPIO_ID      (GPIO_PC)
#define EEPROM_I2C_SDA_AFIO_PIN     (AFIO_PIN_9)
...
/* Exported functions --------------------------------------------------------------------------------------*/
/** @defgroup HT32F54253_DVB_Exported_Functions HT32F54253 Starter kit exported functions
  * @{
  */
