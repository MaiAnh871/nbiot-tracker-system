/*********************************************************************************************************//**
 * @file    ht32f57341_sk.h
 * @version $Rev:: 5659         $
 * @date    $Date:: 2021-11-29 #$
 * @brief   The header file of HT32F57341 Starter kit.
 *************************************************************************************************************
 * @attention
 *
...
#ifndef __HT32F57341_SK_H
#define __HT32F57341_SK_H
...
/** @addtogroup HT32F57341_SK
  * @{
  */


/* Exported constants --------------------------------------------------------------------------------------*/
/** @defgroup HT32F57341_SK_Exported_Constants HT32F57341 Starter kit exported constants
  * @{
  */
extern HT_GPIO_TypeDef* const GPIO_PORT[GPIO_PORT_NUM];

/** @addtogroup HT32F57341_SK_LED
  * @{
  */
#define LEDn                        (3)
...
/** @addtogroup HT32F57341_SK_BUTTON
  * @{
  */
#define BUTTONn                     (3)
...
/** @addtogroup HT32F57341_SK_BUZZER
  * @{
  */
...
/** @addtogroup HT32F57341_SK_SPI_FLASH
  * @{
  */
...
/** @addtogroup HT32F57341_SK_SPI_LCD
  * @{
  */
...
/** @addtogroup HT32F57341_SK_I2C_EEPROM
  * @{
  */
...
/* Exported functions --------------------------------------------------------------------------------------*/
/** @defgroup HT32F57341_SK_Exported_Functions HT32F57341 Starter kit exported functions
  * @{
  */
