/*********************************************************************************************************//**
 * @file    ht32f61245_sk.h
 * @version $Rev:: 6705         $
 * @date    $Date:: 2023-02-03 #$
 * @brief   The header file of HT32F61245 Starter kit.
 *************************************************************************************************************
 * @attention
 *
...
#ifndef __HT32F61245_SK_H
#define __HT32F61245_SK_H
...
/** @addtogroup HT32F61245_SK
  * @{
  */


/* Exported constants --------------------------------------------------------------------------------------*/
/** @defgroup HT32F61245_SK_Exported_Constants HT32F61245 Starter kit exported constants
  * @{
  */
extern HT_GPIO_TypeDef* const GPIO_PORT[GPIO_PORT_NUM];

/** @addtogroup HT32F61245_SK_LED
  * @{
  */
#define LEDn                        (3)
...
/** @addtogroup HT32F61245_SK_BUTTON
  * @{
  */
#define BUTTONn                     (3)
...
#define KEY1_BUTTON_GPIO_ID         (GPIO_PC)
#define KEY1_BUTTON_GPIO_PIN        (GPIO_PIN_14)
#define KEY1_BUTTON_AFIO_MODE       (AFIO_FUN_GPIO)
#define KEY1_BUTTON_EXTI_CHANNEL    (14)

#define KEY2_BUTTON_GPIO_ID         (GPIO_PC)
#define KEY2_BUTTON_GPIO_PIN        (GPIO_PIN_15)
#define KEY2_BUTTON_AFIO_MODE       (AFIO_FUN_GPIO)
#define KEY2_BUTTON_EXTI_CHANNEL    (15)
...
/** @addtogroup HT32F61245_SK_BUZZER
  * @{
  */
#define BUZZER_GPIO_ID              (GPIO_PC)
#define BUZZER_AFIO_PIN             (AFIO_PIN_9)
...
/** @addtogroup HT32F61245_SK_SPI_FLASH
  * @{
  */
#if defined(USE_QSPI_FLASH)
#define FLASH_SPI_CLK(CK)           (CK.Bit.QSPI)
#define FLASH_SPI                   (HT_QSPI)

#define FLASH_SPI_SCK_GPIO_ID       (GPIO_PC)
#define FLASH_SPI_SCK_AFIO_PIN      (AFIO_PIN_11)
#define FLASH_SPI_SCK_AFIO_MODE     (AFIO_FUN_SPI)

#define FLASH_SPI_MOSI_GPIO_ID      (GPIO_PC)       /* QSPI: SIO0 pin                                       */
#define FLASH_SPI_MOSI_AFIO_PIN     (AFIO_PIN_12)
#define FLASH_SPI_MOSI_AFIO_MODE    (AFIO_FUN_SPI)

#define FLASH_SPI_MISO_GPIO_ID      (GPIO_PC)       /* QSPI: SIO1 pin                                       */
#define FLASH_SPI_MISO_AFIO_PIN     (AFIO_PIN_13)
#define FLASH_SPI_MISO_AFIO_MODE    (AFIO_FUN_SPI)

#define FLASH_SPI_SIO2_GPIO_ID      (GPIO_PA)       /* QSPI: SIO2 pin                                       */
#define FLASH_SPI_SIO2_AFIO_PIN     (AFIO_PIN_8)
#define FLASH_SPI_SIO2_AFIO_MODE    (AFIO_FUN_SPI)

#define FLASH_SPI_SIO3_GPIO_ID      (GPIO_PA)       /* QSPI: SIO3 pin                                       */
#define FLASH_SPI_SIO3_AFIO_PIN     (AFIO_PIN_10)
#define FLASH_SPI_SIO3_AFIO_MODE    (AFIO_FUN_SPI)

#define FLASH_SPI_SEL_GPIO_ID       (GPIO_PC)
#define FLASH_SPI_SEL_GPIO_PIN      (GPIO_PIN_10)
#define FLASH_SPI_SEL_AFIO_MODE     (AFIO_FUN_SPI)
#define FLASH_SPI_SEL_CLK(CK)       (CK.Bit.PC)
#else
#define FLASH_SPI_CLK(CK)           (CK.Bit.SPI0)
#define FLASH_SPI                   (HT_SPI0)

#define FLASH_SPI_SCK_GPIO_ID       (GPIO_PB)
#define FLASH_SPI_SCK_AFIO_PIN      (AFIO_PIN_3)
#define FLASH_SPI_SCK_AFIO_MODE     (AFIO_FUN_SPI)

#define FLASH_SPI_MOSI_GPIO_ID      (GPIO_PB)
#define FLASH_SPI_MOSI_AFIO_PIN     (AFIO_PIN_4)
#define FLASH_SPI_MOSI_AFIO_MODE    (AFIO_FUN_SPI)

#define FLASH_SPI_MISO_GPIO_ID      (GPIO_PB)
...
/** @addtogroup HT32F61245_SK_SPI_LCD
  * @{
  */
...
#define LCD_SPI_SEL_GPIO_ID         (GPIO_PA)
...
#define LCD_SPI_BL_GPIO_ID          (GPIO_PC)
#define LCD_SPI_BL_GPIO_PIN         (GPIO_PIN_3)
#define LCD_SPI_BL_AFIO_MODE        (AFIO_FUN_GPIO)
#define LCD_SPI_BL_CLK(CK)          (CK.Bit.PC)

#define LCD_SPI_RST_GPIO_ID         (GPIO_PC)
#define LCD_SPI_RST_GPIO_PIN        (GPIO_PIN_10)
#define LCD_SPI_RST_AFIO_MODE       (AFIO_FUN_GPIO)
#define LCD_SPI_RST_CLK(CK)         (CK.Bit.PC)
/**
  * @}
  */

/** @addtogroup HT32F61245_SK_I2C_EEPROM
  * @{
  */
...
/* Exported functions --------------------------------------------------------------------------------------*/
/** @defgroup HT32F61245_SK_Exported_Functions HT32F61245 Starter kit exported functions
  * @{
  */
