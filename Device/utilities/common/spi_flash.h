...
#ifdef HT_QSPI
#define SPI_FLASH_CMD_4PP               0x38  /*!< Quad input to program the selected page instruction      */
#endif
...
#ifdef HT_QSPI
#define SPI_FLASH_CMD_QREAD             0x6B  /*!< Quad Output Mode Read instruction                        */
#endif
...
#ifdef HT_QSPI
#define QSPI_FLASH_BufferWrite(a,b,c)           SPI_FLASH_BufferWriteBy(a,b,c,(pWriteFunction)QSPI_FLASH_QuadPageWrite);
#define QSPI_FLASH_BufferWriteByDMA(a,b,c)      SPI_FLASH_BufferWriteBy(a,b,c,(pWriteFunction)QSPI_FLASH_QuadPageWriteByDMA);
#endif
