...
rem del /S Project_32002*.* 32002.mk
rem del /S Project_32003*.* 32003.mk
rem del /S Project_50230*.* 50230.mk
rem del /S Project_50241*.* 50241.mk
rem del /S Project_50343*.* 50343.mk
...
rem del /S Project_54241*.* 54241.mk
rem del /S Project_54253*.* 54253.mk
rem del /S Project_57341*.* 57341.mk
rem del /S Project_57352*.* 57352.mk
rem del /S Project_61352*.* 61352.mk
rem del /S Project_65240*.* 65240.mk DVB_NO_SUPPORT
del /S Project_65232*.* 65232.mk
rem del /S Project_59041*.* 59041.mk
rem del /S Project_59741*.* 59741.mk
rem del /S Project_5032*.* 5032.mk
rem del /S Project_61355*.* 61355.mk
rem del /S Project_61356*.* 61356.mk
rem del /S Project_61357*.* 61357.mk
rem del /S Project_67741*.* 67741.mk
rem del /S Project_5828*.* 5828.mk
...
REM ============================================================================
gsar.exe -s"#define HSE_ENABLE        (1)" -r"#define HSE_ENABLE        (0)" system_ht32f*.c -o
gsar.exe -s"#define PLL_CLK_SRC       (0)" -r"#define PLL_CLK_SRC       (1)" system_ht32f*.c -o
gsar.exe -s"#define HCLK_SRC          (2)" -r"#define HCLK_SRC          (3)" system_ht32f*.c -o