...
void SysClockConfig_PLL(void)
{
  ...
  */
  ...
  PLL_InitStruct.CFG = CKCU_PLL_8M_60M;
  #else
  PLL_InitStruct.CFG = CKCU_PLL_8M_48M;
  #endif
  ...
  FLASH_SetWaitState(FLASH_WAITSTATE_MAX);
  #endif
...
void CKCU_LoadTrimValue(void)
{
  ...
  pSaveTrim = (SaveAutoTrim_TypeDef*) SAVE_AUTO_TRIM_ADDRESS;
...
void GPIO_Configuration(void)
{
  ...
  /*--------------------------------------------------------------------------------------------------------*/
  AFIO_EXTISourceConfig(KEY1_BUTTON_EXTI_CHANNEL, KEY1_BUTTON_GPIO_ID);
}
...
void USBPLL_Configuration(void)
{
  { /* USB PLL configuration                                                                                */
    ...
    */
    ...
    PLLInit.ClockSource = CKCU_PLLSRC_HSI;  // CKCU_PLLSRC_HSE or CKCU_PLLSRC_HSI
