...
u8 rbit_byte(u8 in);
u32 crc32_fast(u32 crc, u8 *buffer, u32 length);
...
/* CRC table for the CRC-32. The poly is 0x04C11DB7
...
/*********************************************************************************************************//**
  * @brief  SW CRC, move data by software.
  * @retval None
  ***********************************************************************************************************/
void test_fun1(void)
{
  ...
  SW_sum = crc32_fast(seed, crc_dat_reverse, sizeof(crc_dat_reverse));
  SW_sum = RBIT(SW_sum) ^ 0xFFFFFFFF;
  printf("sum = 0x%08X", SW_sum);
}

/*********************************************************************************************************//**
  * @brief  HW1 CRC, move data by CPU.
  * @retval None
  ***********************************************************************************************************/
void test_fun2(void)
{
...
/*********************************************************************************************************//**
  * @brief  HW2 CRC, move data by CPU.
  * @retval None
  ***********************************************************************************************************/
void test_fun3(void)
{
...
#if (LIBCFG_PDMA)
/*********************************************************************************************************//**
  * @brief  HW3 CRC, move data by PDMA.
  * @retval None
  ***********************************************************************************************************/
void test_fun4(void)
{
...
{
  while (length--)
    crc = crc32_table[((crc >> 24) ^ *buffer++) & 0xFF] ^ (crc << 8);
...
void CRC_Configuration(void)
{
  ...
  */
  ...
  CRC_InitStructure.Mode = CRC_32_POLY;
  CRC_InitStructure.uSeed = seed;
  CRC_InitStructure.uCR = 0;
