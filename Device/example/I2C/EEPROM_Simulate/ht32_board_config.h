...
#define LOOP_BACK      (1)  /* 0: Configure Slave or Master, 1: Configure Slave / Master transfer by self.  */
  ...
  #ifdef LOOP_BACK
    #error "This example code does not apply to the chip you selected on Loop-Back mode.You can commented LOOP_BACK."
  #endif
  ...
  #define HTCFG_I2C_EEPROM_CLK(ck)         (ck.Bit.I2C0)
  #define HTCFG_I2C_EEPROM_PORT            (HT_I2C0)
  #define HTCFG_I2C_EEPROM_SCL_GPIO_ID     (GPIO_PB)
  #define HTCFG_I2C_EEPROM_SCL_AFIO_PIN    (AFIO_PIN_7)
  #define HTCFG_I2C_EEPROM_SDA_GPIO_ID     (GPIO_PB)
  #define HTCFG_I2C_EEPROM_SDA_AFIO_PIN    (AFIO_PIN_8)
  #define HTCFG_I2C_EEPROM_IRQn            (I2C0_IRQn)
#endif
