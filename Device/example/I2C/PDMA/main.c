...
int main(void)
{
  ...
  /* The I2C master-slave state is checked by software and data is read by PDMA.                            */
  I2C_Loopback();
...
/*********************************************************************************************************//**
  * @brief  The I2C master-slave state is checked by software and data is read from the master to the slave by PDMA.
  * @retval None
  ***********************************************************************************************************/
void I2C_Loopback(void)
{
