...
/* Settings ------------------------------------------------------------------------------------------------*/
  ...
  #define HTCFG_EXTI_KEY1_IRQHandler           (EXTI2_3_IRQHandler)
#endif
  ...
  #define HTCFG_INT_GPIO_ID                    (GPIO_PB)               // D2
  #define HTCFG_INT_GPIO_PIN                   (GPIO_PIN_0)
  #define HTCFG_INT_CLK(CK)                    (CK.Bit.PB)
  ...
  #define HTCFG_SLAVE_SPI_SCK_GPIO_ID          (GPIO_PA)               // D27
  #define HTCFG_SLAVE_SPI_SCK_AFIO_PIN         (AFIO_PIN_4)

  #define HTCFG_SLAVE_SPI_MOSI_GPIO_ID         (GPIO_PA)               // D28
  #define HTCFG_SLAVE_SPI_MOSI_AFIO_PIN        (AFIO_PIN_5)

  #define HTCFG_SLAVE_SPI_MISO_GPIO_ID         (GPIO_PA)               // D26
  #define HTCFG_SLAVE_SPI_MISO_AFIO_PIN        (AFIO_PIN_6)

  #define HTCFG_SLAVE_SPI_SEL_GPIO_ID          (GPIO_PA)               // D29
  #define HTCFG_SLAVE_SPI_SEL_AFIO_PIN         (GPIO_PIN_7)
  #define HTCFG_SLAVE_CLK(CK)                  (CK.Bit.PA)
  ...
  #define HTCFG_SLAVE_SPI_SCK_GPIO_ID          (GPIO_PC)
  #define HTCFG_SLAVE_SPI_SCK_AFIO_PIN         (AFIO_PIN_5)

  #define HTCFG_SLAVE_SPI_MOSI_GPIO_ID         (GPIO_PC)
  #define HTCFG_SLAVE_SPI_MOSI_AFIO_PIN        (AFIO_PIN_6)

  #define HTCFG_SLAVE_SPI_MISO_GPIO_ID         (GPIO_PC)
  ...
  #define HTCFG_SLAVE_SPI_SCK_GPIO_ID          (GPIO_PC)
  #define HTCFG_SLAVE_SPI_SCK_AFIO_PIN         (AFIO_PIN_7)
  ...
  #define HTCFG_SLAVE_SPI_SEL_GPIO_ID          (GPIO_PC)
  #define HTCFG_SLAVE_SPI_SEL_AFIO_PIN         (GPIO_PIN_6)
  #define HTCFG_SLAVE_CLK(CK)                  (CK.Bit.PC)
  ...
  #define HTCFG_SLAVE_SPI_SCK_GPIO_ID          (GPIO_PC)
  #define HTCFG_SLAVE_SPI_SCK_AFIO_PIN         (AFIO_PIN_0)
  ...
  #define HTCFG_SLAVE_SPI_SEL_GPIO_ID          (GPIO_PB)
  #define HTCFG_SLAVE_SPI_SEL_AFIO_PIN         (GPIO_PIN_15)
  #define HTCFG_SLAVE_CLK(CK)                  (CK.Bit.PB)
  ...
  #define HTCFG_SLAVE_SPI_MOSI_GPIO_ID         (GPIO_PA)
  #define HTCFG_SLAVE_SPI_MOSI_AFIO_PIN        (AFIO_PIN_1)
  ...
  #define HTCFG_SLAVE_SPI_MOSI_GPIO_ID         (GPIO_PA)
  #define HTCFG_SLAVE_SPI_MOSI_AFIO_PIN        (AFIO_PIN_2)

  #define HTCFG_SLAVE_SPI_MISO_GPIO_ID         (GPIO_PA)
  #define HTCFG_SLAVE_SPI_MISO_AFIO_PIN        (AFIO_PIN_3)
