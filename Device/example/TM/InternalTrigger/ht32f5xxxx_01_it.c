/*********************************************************************************************************//**
 * @file    TM/InternalTrigger/ht32f5xxxx_01_it.c
 * @version $Rev:: 5184         $
...
/*********************************************************************************************************//**
 * @brief   This function handles master timer interrupt.
 * @retval  None
 ************************************************************************************************************/
void HTCFG_MASTER_IRQHandler(void)
{
  TM_ClearIntPendingBit(HTCFG_MASTER_PORT, TM_INT_UEV); /* Clear update event flag                          */
}

/*********************************************************************************************************//**
 * @brief   This function handles slave timer interrupt.
 * @retval  None
 ************************************************************************************************************/
void HTCFG_SLAVE_IRQHandler(void)
{
  static vu32 gPwmCounter;
  TM_ClearIntPendingBit(HTCFG_SLAVE_PORT, TM_INT_UEV); /* Clear update event flag                           */

  gPwmCounter++;
  if(gPwmCounter == PWM_COUNTER)
  {
    /* PWM has been output 5 times. Disable slave timer and wait for next trigger.                          */
    TM_Cmd(HTCFG_SLAVE_PORT, DISABLE);
    gPwmCounter = 0;
  }
}
