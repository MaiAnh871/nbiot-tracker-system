/**
 @page ADC_InternalReferenceVoltage_PWMTrigger

 @verbatim
 * @file    ADC/InternalReferenceVoltage_PWMTrigger/readme.txt
 * @version V2.00
 * @date    2020-02-27
 * @brief   Description of Internal VREF example.
 @endverbatim
...
This example shows how to use the ADC internal reference voltage (VREF) to calculate the voltage value of
MVDDA and another ADC input.
...
- ADC/InternalReferenceVoltage_PWMTrigger/main.c                       Main program
- ADC/InternalReferenceVoltage_PWMTrigger/ht32fxxxx_it.c               Interrupt handlers
- ADC/InternalReferenceVoltage_PWMTrigger/ht32_board_config.h          Board configuration file
