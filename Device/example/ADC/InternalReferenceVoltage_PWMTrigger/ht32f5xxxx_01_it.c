/*********************************************************************************************************//**
 * @file    ADC/InternalReferenceVoltage_PWMTrigger/ht32f5xxxx_01_it.c
 * @version $Rev:: 6308         $
...
void ADC_IRQHandler(void)
{
  ...
  if (ADC_GetIntStatus(HT_ADC0, ADC_INT_CYCLE_EOC) == SET)
  {
    ...
    gADC_Result[0] = HT_ADC0->DR[0] & 0x0FFF;    // MVDDA Conversion Result
    gADC_Result[1] = HT_ADC0->DR[1] & 0x0FFF;    // IVREF Conversion Result
    gADC_Result[2] = HT_ADC0->DR[2] & 0x0FFF;    // Potentiometer Conversion Result
  }
}
