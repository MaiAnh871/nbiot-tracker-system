...
void SCI_Configuration(void)
{
  ...
  */
  ...
  AFIO_GPxConfig(HTCFG_SMARTCARD_CLK_GPIO_ID, HTCFG_SMARTCARD_CLK_AFIO_PIN, AFIO_FUN_SCI);
  AFIO_GPxConfig(HTCFG_SMARTCARD_DIO_GPIO_ID, HTCFG_SMARTCARD_DIO_AFIO_PIN, AFIO_FUN_SCI);
  AFIO_GPxConfig(HTCFG_SMARTCARD_DET_GPIO_ID, HTCFG_SMARTCARD_DET_AFIO_PIN, AFIO_FUN_SCI);

  /*  Configure SmartCard interface CMD pin.                                                                */
  AFIO_GPxConfig(HTCFG_SMARTCARD_CMD_GPIO_ID, HTCFG_SMARTCARD_CMD_AFIO_PIN, AFIO_FUN_GPIO);
  ...
  AFIO_GPxConfig(HTCFG_SMARTCARD_RSTN_GPIO_ID, HTCFG_SMARTCARD_RSTN_AFIO_PIN, AFIO_FUN_GPIO);
