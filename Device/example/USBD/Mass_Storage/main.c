...
void CKCU_Configuration(void)
{
  ...
  SD_SPI_SEL_CLK(CKCUClock) = 1;
  SD_SPI_CLK(CKCUClock) = 1;
  SD_SPI_MISO_CLK(CKCUClock) = 1;
...
void GPIO_Configuration(void)
{
  ...
  /*--------------------------------------------------------------------------------------------------------*/
  AFIO_GPxConfig(SD_SPI_SCK_GPIO_ID, SD_SPI_SCK_AFIO_PIN, SD_SPI_SCK_AFIO_MODE);
  AFIO_GPxConfig(SD_SPI_MISO_GPIO_ID, SD_SPI_MISO_AFIO_PIN, SD_SPI_MISO_AFIO_MODE);
  AFIO_GPxConfig(SD_SPI_MOSI_GPIO_ID, SD_SPI_MOSI_AFIO_PIN, SD_SPI_MOSI_AFIO_MODE);

  /*  Configure SPI SEL pin                                                                                 */
  GPIO_SetOutBits(GPIO_PORT[SD_SPI_SEL_GPIO_ID], SD_SPI_SEL_GPIO_PIN);
  GPIO_DirectionConfig(GPIO_PORT[SD_SPI_SEL_GPIO_ID], SD_SPI_SEL_GPIO_PIN, GPIO_DIR_OUT);

  GPIO_DriveConfig(GPIO_PORT[SD_SPI_SCK_GPIO_ID], SD_SPI_SCK_AFIO_PIN, GPIO_DV_16MA);
  GPIO_DriveConfig(GPIO_PORT[SD_SPI_MISO_GPIO_ID], SD_SPI_MISO_AFIO_PIN, GPIO_DV_16MA);
  GPIO_DriveConfig(GPIO_PORT[SD_SPI_MOSI_GPIO_ID], SD_SPI_MOSI_AFIO_PIN, GPIO_DV_16MA);
