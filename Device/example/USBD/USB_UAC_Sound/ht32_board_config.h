...
/* Settings ------------------------------------------------------------------------------------------------*/
  ...
  #define HTCFG_I2CM_CKCU(ck)                              (ck.Bit.I2C1)
  #define HTCFG_I2CM_IRQ                                   (I2C1_IRQn)
  #define HTCFG_I2CM_MASTER_SCK_ID                         (GPIO_PC)               // A5/D19
  #define HTCFG_I2CM_MASTER_SCK_AFIO_PIN                   (AFIO_PIN_4)
  #define HTCFG_I2CM_MASTER_SDA_ID                         (GPIO_PC)               // A4/D18
  #define HTCFG_I2CM_MASTER_SDA_AFIO_PIN                   (AFIO_PIN_5)

  #define HTCFG_I2S_BCLK_ID                                (GPIO_PC)               // D13
  #define HTCFG_I2S_BCLK_ADIO_PIN                          (AFIO_PIN_11)
  #define HTCFG_I2S_SDO_ID                                 (GPIO_PC)               // D21
  #define HTCFG_I2S_SDO_ADIO_PIN                           (AFIO_PIN_12)
  #define HTCFG_I2S_SDI_ID                                 (GPIO_PC)               // D20
  #define HTCFG_I2S_SDI_ADIO_PIN                           (AFIO_PIN_13)
  #define HTCFG_I2S_MCLK_ID                                (GPIO_PC)               // A0/D14
  #define HTCFG_I2S_MCLK_ADIO_PIN                          (AFIO_PIN_1)
  #define HTCFG_I2S_WS_ID                                  (GPIO_PA)               // A6/D30
  ...
  #define HTCFG_I2S_BCLK_ID                                (GPIO_PA)
  #define HTCFG_I2S_BCLK_ADIO_PIN                          (AFIO_PIN_1)
  #define HTCFG_I2S_SDO_ID                                 (GPIO_PA)
  #define HTCFG_I2S_SDO_ADIO_PIN                           (AFIO_PIN_2)
  #define HTCFG_I2S_SDI_ID                                 (GPIO_PA)
