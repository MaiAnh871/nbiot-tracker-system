...
REM ============================================================================
gsar.exe -s"<ScatterFile></ScatterFile>" -r"<ScatterFile>..\linker.lin</ScatterFile>" MDK_ARM\*.uvproj -o
gsar.exe -s"<ScatterFile></ScatterFile>" -r"<ScatterFile>..\linker.lin</ScatterFile>" MDK_ARMv5\*.uvprojx -o
gsar.exe -s"<ScatterFile></ScatterFile>" -r"<ScatterFile>..\linker.lin</ScatterFile>" MDK_ARMv537\*.uvprojx -o
