...
int main(void)
{
  ...
  AES_ECB_Init(HT_AES, &AES_InitStruct);  /* AES ECB Init                                                   */
...
{
  /* Encryption                                                                                             */
  if (!AES_ECB_CryptData(HT_AES, AES_DIR_ENCRYPT, BUFF_SIZE, u8OrgData, u8CipherText))
  {
  ...
  /* Decryption                                                                                             */
  if (!AES_ECB_CryptData(HT_AES, AES_DIR_DECRYPT, BUFF_SIZE, u8CipherText, u8PlainText))
  {
    /* Input length must be a multiple of 16                                                                */
