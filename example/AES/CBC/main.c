...
u8 u8PlainText[BUFF_SIZE];
u8 u8CipherText[BUFF_SIZE];
...
int main(void)
{
  ...
  AES_CBC_Init(HT_AES, &AES_InitStruct);  /* AES CBC Init                                                   */
...
{
  /* Encryption                                                                                             */
  if (!AES_CBC_CryptData(HT_AES, AES_DIR_ENCRYPT, u8InitVector, BUFF_SIZE, u8OrgData, u8CipherText))
  {
  ...
  /* Decryption                                                                                             */
  if (!AES_CBC_CryptData(HT_AES, AES_DIR_DECRYPT, u8InitVector, BUFF_SIZE, u8CipherText, u8PlainText))
  {
    /* Input length must be a multiple of 16                                                                */
...
void AES_Result(void)
{
  ...
  {
    printf("%03d     |0x%02X     |0x%02X        |0x%02X\r\n", i + 1, u8OrgData[i], u8CipherText[i], u8PlainText[i]);
  }
  printf("\r\n");
  printf("--------------------------------------\r\n");
