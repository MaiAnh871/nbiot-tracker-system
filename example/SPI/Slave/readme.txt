...
transmitted, then set specify GPIO as low to inform the master to start the transmission. After the 8 data are
received, the example shows the data by RS232.

@par Directory Contents:

- SPI/Slave/main.c               Main program
- SPI/Slave/ht32fxxxx_it.c       Interrupt handlers
