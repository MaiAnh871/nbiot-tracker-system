...
/* Settings ------------------------------------------------------------------------------------------------*/
  ...
  #define HTCFG_SLED_CK_PRESCALER                  (3)       /* F_PCLK/HTCFG_SLED_CK_PRESCALER     = 20 MHz */
  #define HTCFG_SLED_BAUDRATE                      (25)      /* F_SCLK/HTCFG_SLED_BAUDRATE         = 800 kHz*/
  #define HTCFG_SLED_T0H                           (5)       /* 5/25 = 20% Duty. 1/800K * (5/25)   = 0.25 us*/
  #define HTCFG_SLED_TH1                           (20)      /* 20/25 = 80% Duty. 1/800K * (20/25) = 1.00 us*/
