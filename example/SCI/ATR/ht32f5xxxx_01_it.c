...
{
  vu32 tmpvalue = HTCFG_SMARTCARD_SCI->IPR;
  ...
  {
    /*  Enable SmartCard interface CMDVCC pin  */
    GPIO_ClearOutBits(GPIO_PORT[HTCFG_SMARTCARD_CMD_GPIO_ID], HTCFG_SMARTCARD_CMD_GPIO_PIN);
    /*  Set SmartCard interface RSTIN pin high */
    GPIO_SetOutBits(GPIO_PORT[HTCFG_SMARTCARD_RSTN_GPIO_ID], HTCFG_SMARTCARD_RSTN_GPIO_PIN);
