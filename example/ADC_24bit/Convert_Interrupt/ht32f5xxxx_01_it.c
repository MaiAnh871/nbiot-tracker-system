/*********************************************************************************************************//**
 * @file    ADC_24bit/Convert_Interrupt/ht32f5xxxx_01_it.c
 * @version $Rev:: 5193         $
 ...
 * @retval  None
 ************************************************************************************************************/
void DRDYB_EXTI_IRQHandler(void)
{
  if (EXTI_GetEdgeStatus(HTCFG_DRDYB_EXTI_CHANNEL, EXTI_EDGE_NEGATIVE))
  {
    EXTI_ClearEdgeFlag(HTCFG_DRDYB_EXTI_CHANNEL);
    ADC24_IRQHandler();
  }
}
