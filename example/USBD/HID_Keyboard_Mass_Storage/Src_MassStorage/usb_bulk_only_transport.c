/*********************************************************************************************************//**
 * @file    Src_MassStorage/usb_bulk_only_transport.c
 * @version $Rev:: 4860         $
...
void BOT_SendCSW(BOT_CSW_STATUS_Enum status)
{
  ...
  /* Cause the address-of-packed-member warning of GNU_ARM,                                                 */
  /* skip by #pragma GCC diagnostic ignored "-Waddress-of-packed-member".                                   */
