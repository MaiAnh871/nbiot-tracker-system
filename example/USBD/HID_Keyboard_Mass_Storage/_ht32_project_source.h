/*********************************************************************************************************//**
 * @file    USBD/HID_Keyboard_Mass_Storage/_ht32_project_source.h
 * @version $Rev:: 4518         $
...
/* Includes ------------------------------------------------------------------------------------------------*/
#include "Src_MassStorage\ram_disk.c"
#include "Src_MassStorage\usb_bulk_only_transport.c"
#include "Src_MassStorage\usb_scsi_block_command.c"
