...
static void USBDClass_EPT4InProcess(void)
{
  ...
  {
    u8 tempBuffer[4];
    tempBuffer[0] = gInputDataBuffer[6];
    tempBuffer[1] = gInputDataBuffer[7];
    tempBuffer[2] = gInputDataBuffer[8];
    tempBuffer[3] = gInputDataBuffer[9];
    temp = (tempBuffer[3] << 24) | (tempBuffer[2] << 16) | (tempBuffer[1] << 8) | tempBuffer[0];
...
static void USBDClass_StartOfFrame(u32 uPara)
{
  ...
  {
    u8 tempBuffer[4];
    tempBuffer[0] = gInputDataBuffer[2];
    tempBuffer[1] = gInputDataBuffer[3];
    tempBuffer[2] = gInputDataBuffer[4];
    tempBuffer[3] = gInputDataBuffer[5];

    temp_long = (tempBuffer[3] << 24) | (tempBuffer[2] << 16) | (tempBuffer[1] << 8) | tempBuffer[0];
