/**
 @page Time_TimeFun_UserConf

 @verbatim
 * @file    Time/TimeFun_UserConf/readme.txt
 * @version V1.00
 * @date    2021-05-27
 * @brief   Description of Time function with user space configuration file.
 @endverbatim

@par Example Description:

This example shows how to use the HT32 Time function to achieve delay, time measure, and timeout functions
with user space configuration file ("ht32_time_conf.h"). It demonstrates the HT32 Time function usage on the
older firmware library. User can copy the "ht32_time_conf.h" and following files into their code to use it.
  //library/HT32Fxxxxx_Driver/src/ht32_time.c
  //library/HT32Fxxxxx_Driver/inc/ht32_time.h
...
- Time/TimeFun_UserConf/main.c                              Main program
- Time/TimeFun_UserConf/ht32fxxxxx_nn_it.c                  Interrupt handlers
- Time/TimeFun_UserConf/ht32_time_conf.h                    Configuration of HT32 Time function
