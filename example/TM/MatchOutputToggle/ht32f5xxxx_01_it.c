/*********************************************************************************************************//**
 * @file    TM/MatchOutputToggle/ht32f5xxxx_01_it.c
 * @version $Rev:: 6403         $
 ...
 * @retval  None
 ************************************************************************************************************/
void HTCFG_COMP_IRQHandler(void)
{
  extern u32 CH_DeltaCCR[];

  if (TM_GetIntStatus(HTCFG_COMP_PORT, TM_INT_CH0CC) != RESET)
  {
    TM_ClearIntPendingBit(HTCFG_COMP_PORT, TM_INT_CH0CC);
    TM_SetCaptureCompare0(HTCFG_COMP_PORT, TM_GetCaptureCompare0(HTCFG_COMP_PORT) + CH_DeltaCCR[0]);
  }

  if (TM_GetIntStatus(HTCFG_COMP_PORT, TM_INT_CH1CC) != RESET)
  {
    TM_ClearIntPendingBit(HTCFG_COMP_PORT, TM_INT_CH1CC);
    TM_SetCaptureCompare1(HTCFG_COMP_PORT, TM_GetCaptureCompare1(HTCFG_COMP_PORT) + CH_DeltaCCR[1]);
  }

  #if (LIBCFG_TM_SCTM_2CHANNEL == 0)
  if (TM_GetIntStatus(HTCFG_COMP_PORT, TM_INT_CH2CC) != RESET)
  {
    TM_ClearIntPendingBit(HTCFG_COMP_PORT, TM_INT_CH2CC);
    TM_SetCaptureCompare2(HTCFG_COMP_PORT, TM_GetCaptureCompare2(HTCFG_COMP_PORT) + CH_DeltaCCR[2]);
  }

  if (TM_GetIntStatus(HTCFG_COMP_PORT, TM_INT_CH3CC) != RESET)
  {
    TM_ClearIntPendingBit(HTCFG_COMP_PORT, TM_INT_CH3CC);
    TM_SetCaptureCompare3(HTCFG_COMP_PORT, TM_GetCaptureCompare3(HTCFG_COMP_PORT) + CH_DeltaCCR[3]);
  }
  #endif
}
