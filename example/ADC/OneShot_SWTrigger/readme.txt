/**
 @page ADC_OneShot_SWTrigger

 @verbatim
 * @file    ADC/OneShot_SWTrigger/readme.txt
 * @version V1.00
 * @date    2022-10-20
...
This example shows how to measure the potentiometer levels using ADC one shot mode trigger by software.

  <PRE>
  ================     =================     =================     =================
  =              =     =               =     =    ADC ISR    =     =     Main()    =
  =    main()    = --> =      ADC      = --> =   Save Value  = --> =     print     =
...
The cycle-end of conversion interrupt is enabled. Each time the ADC cycle conversion is finished,
a "cycle-end of conversion" interrupt will be occurred. 
The ADC interrupt service routine will store the ADC result into the global variable, "gADC_Result".
...
- ADC/ADC_OneShot_SWTrigger/ht32fxxxxx_nn_it.c         Interrupt handlers
