...
#define ADC_GROUP_LIST_LENGTH         (4)   // Same length of two group, the PDMA setting is more easy
...
#define ADC_GROUP2_LIST0              (ADC_CH_4)
#define ADC_GROUP2_LIST1              (ADC_CH_5)
#define ADC_GROUP2_LIST2              (ADC_CH_6)
#define ADC_GROUP2_LIST3              (ADC_CH_7)
#if !defined(USE_HT32F50020_30)
...
/* Exported macro ------------------------------------------------------------------------------------------*/
#if (LIBCFG_PDMA == 0) && (ADC_GROUP_DATA_MODE == 1)
