...
/* Settings ------------------------------------------------------------------------------------------------*/
  ...
  #define HTCFG_MCTM_CH0_GPIO_ID                      (GPIO_PA)               // D8
  #define HTCFG_MCTM_CH0N_GPIO_ID                     (GPIO_PA)               // D9
  #define HTCFG_MCTM_CH1_GPIO_ID                      (GPIO_PB)               // D2
  #define HTCFG_MCTM_CH1N_GPIO_ID                     (GPIO_PB)               // D3
  #define HTCFG_MCTM_CH2_GPIO_ID                      (GPIO_PB)               // D4
  #define HTCFG_MCTM_CH2N_GPIO_ID                     (GPIO_PB)               // D5
  #define HTCFG_MCTM_BREAK_GPIO_ID                    (GPIO_PB)               // D6
  ...
  #define HTCFG_MCTM_CH0_GPIO_ID                      (GPIO_PB)
  #define HTCFG_MCTM_CH0N_GPIO_ID                     (GPIO_PC)
  #define HTCFG_MCTM_CH1_GPIO_ID                      (GPIO_PA)
  #define HTCFG_MCTM_CH1N_GPIO_ID                     (GPIO_PA)
  #define HTCFG_MCTM_CH2_GPIO_ID                      (GPIO_PC)
  #define HTCFG_MCTM_CH2N_GPIO_ID                     (GPIO_PC)
  #define HTCFG_MCTM_BREAK_GPIO_ID                    (GPIO_PC)

  #define HTCFG_MCTM_CH0_AFIO_PIN                     (AFIO_PIN_15)
  #define HTCFG_MCTM_CH0N_AFIO_PIN                    (AFIO_PIN_0)
  #define HTCFG_MCTM_CH1_AFIO_PIN                     (AFIO_PIN_10)
  #define HTCFG_MCTM_CH1N_AFIO_PIN                    (AFIO_PIN_11)
  #define HTCFG_MCTM_CH2_AFIO_PIN                     (AFIO_PIN_6)
  #define HTCFG_MCTM_CH2N_AFIO_PIN                    (AFIO_PIN_7)
  #define HTCFG_MCTM_BREAK_AFIO_PIN                   (AFIO_PIN_3)
  ...
  #define HTCFG_MCTM_CH0_GPIO_ID                      (GPIO_PB)
  #define HTCFG_MCTM_CH0N_GPIO_ID                     (GPIO_PB)
  #define HTCFG_MCTM_CH1_GPIO_ID                      (GPIO_PB)
  #define HTCFG_MCTM_CH1N_GPIO_ID                     (GPIO_PB)
  #define HTCFG_MCTM_CH2_GPIO_ID                      (GPIO_PA)
  #define HTCFG_MCTM_CH2N_GPIO_ID                     (GPIO_PA)
  #define HTCFG_MCTM_BREAK_GPIO_ID                    (GPIO_PB)

  #define HTCFG_MCTM_CH0_AFIO_PIN                     (AFIO_PIN_3)
  #define HTCFG_MCTM_CH0N_AFIO_PIN                    (AFIO_PIN_2)
  #define HTCFG_MCTM_CH1_AFIO_PIN                     (AFIO_PIN_1)
  #define HTCFG_MCTM_CH1N_AFIO_PIN                    (AFIO_PIN_0)
  #define HTCFG_MCTM_CH2_AFIO_PIN                     (AFIO_PIN_15)
  #define HTCFG_MCTM_CH2N_AFIO_PIN                    (AFIO_PIN_14)
  #define HTCFG_MCTM_BREAK_AFIO_PIN                   (AFIO_PIN_6)
  #define HTCFG_MCTM_RELOAD                           (60000000/2000)
  #define HTCFG_MCTM_DEAD_TIME                        (90)
#endif
  ...
  #define HTCFG_MCTM_CH2_AFIO_PIN                     (AFIO_PIN_15)
  #define HTCFG_MCTM_CH2N_AFIO_PIN                    (AFIO_PIN_14)
  #define HTCFG_MCTM_BREAK_AFIO_PIN                   (AFIO_PIN_1)
  #define HTCFG_MCTM_RELOAD                           (60000000/2000)
  #define HTCFG_MCTM_DEAD_TIME                        (90)
#endif
