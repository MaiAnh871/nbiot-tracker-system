...
/* Settings ------------------------------------------------------------------------------------------------*/
  ...
  #define HTCFG_I2C_SLAVE_SCL_AFIO_PIN     (AFIO_PIN_7)
  #define HTCFG_I2C_SLAVE_SDA_GPIO_ID      (GPIO_PB)
  #define HTCFG_I2C_SLAVE_SDA_AFIO_PIN     (AFIO_PIN_8)
#endif
  ...
  #define HTCFG_I2C_SLAVE_CLK(ck)          (ck.Bit.I2C0)
  #define HTCFG_I2C_SLAVE_PORT             (HT_I2C0)
  #define HTCFG_I2C_SLAVE_SCL_GPIO_ID      (GPIO_PC)
  ...
  #define HTCFG_I2C_SLAVE_PORT             (HT_I2C0)
  #define HTCFG_I2C_SLAVE_SCL_GPIO_ID      (GPIO_PA)
  #define HTCFG_I2C_SLAVE_SCL_AFIO_PIN     (AFIO_PIN_10)
  #define HTCFG_I2C_SLAVE_SDA_GPIO_ID      (GPIO_PA)
  #define HTCFG_I2C_SLAVE_SDA_AFIO_PIN     (AFIO_PIN_11)
#endif
