...
/* Private constants ---------------------------------------------------------------------------------------*/
#define I2C_MASTER_ADDRESS     0x10A
#define I2C_SLAVE_ADDRESS      0x360
#define BufferSize             4
...
int main(void)
{
  ...
  /* Check the status of the I2C master-slave step and send data from the master to the slave.              */
  I2C_Loopback();
...
/*********************************************************************************************************//**
  * @brief  Check the status of the I2C master-slave step and send data from the master to the slave.
  * @retval None
  ***********************************************************************************************************/
void I2C_Loopback(void)
{
