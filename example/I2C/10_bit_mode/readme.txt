/**
 @page I2C_10_bit_mode

 @verbatim
 * @file    I2C/10_bit_mode/readme.txt
 * @version V1.00
 * @date    2022-11-24
 * @brief   Description of I2C 10 bit mode example.
 @endverbatim

@par Example Description:

This example describes how to configure I2C0 to I2C1 transmission in 10 bit mode.
...
- I2C/10_bit_mode/main.c               Main program
- I2C/10_bit_mode/ht32fxxxx_it.c       Interrupt handlers
