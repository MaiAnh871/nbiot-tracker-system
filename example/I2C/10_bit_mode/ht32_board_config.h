...
/* Settings ------------------------------------------------------------------------------------------------*/
  ...
  #define I2C_MASTER_PORT            (HT_I2C1)
  #define I2C_MASTER_SCL_GPIO_ID     (GPIO_PC)               // A5/D19
  #define I2C_MASTER_SCL_AFIO_PIN    (AFIO_PIN_4)
  #define I2C_MASTER_SDA_GPIO_ID     (GPIO_PC)               // A4/D18
  #define I2C_MASTER_SDA_AFIO_PIN    (AFIO_PIN_5)

  #define I2C_SLAVE_PORT             (HT_I2C0)
  #define I2C_SLAVE_SCL_GPIO_ID      (GPIO_PC)               // D21
  #define I2C_SLAVE_SCL_AFIO_PIN     (AFIO_PIN_12)
  #define I2C_SLAVE_SDA_GPIO_ID      (GPIO_PC)               // D20
  #define I2C_SLAVE_SDA_AFIO_PIN     (AFIO_PIN_13)
#endif
