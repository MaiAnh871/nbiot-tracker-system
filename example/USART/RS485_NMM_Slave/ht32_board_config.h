...
/* Settings ------------------------------------------------------------------------------------------------*/
  ...
  #define _HTCFG_UART_TX_GPIOX                    A               // D27
  #define _HTCFG_UART_TX_GPION                    4
  #define _HTCFG_UART_RX_GPIOX                    A               // D28
  #define _HTCFG_UART_RX_GPION                    5
  #define _HTCFG_UART_RTS_GPIOX                   A               // D26
  #define _HTCFG_UART_RTS_GPION                   6
  #define HTCFG_UART_IPN                          USART1
#endif
  ...
  #define _HTCFG_UART_RTS_GPION                   4
  #define HTCFG_UART_IPN                          USART0
#endif
...
#define HTCFG_UART_RTS_GPIO_ID                    STRCAT2(GPIO_P,         _HTCFG_UART_RTS_GPIOX)
...
#define HTCFG_UART_RTS_AFIO_PIN                   STRCAT2(AFIO_PIN_,      _HTCFG_UART_RTS_GPION)
