...
This example shows how to use the LCD functions to communicate with LCD. For more information, please refer to
the "xxx_lcd.c" file and check the document of LCD driver. This example will show the text as below and
followed by a holtek whale logo picture on LCD.
...
- LCD/LCD28/main.c               Main program
- LCD/LCD28/ht32fxxxx_it.c       Interrupt handlers
- LCD/LCD28/picture.h            picture data
